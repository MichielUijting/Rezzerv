...
def main() -> int:
    ...
    for marker in ("REUSED", "ATTACHED", "DISPATCHED"):
        require(
            f"grep -E '^F7_FULL_{marker}_COUNT=[0-9]+
...
if __name__ == "__main__":
 ...
 f7-full-dispatch.log" in full_text,
            f"Full dispatch {marker.lower()} counter guard must accept the configured authority inventory",
        )
