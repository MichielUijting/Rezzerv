...
def detect_store_hint(text: str, filename: str) -> str:
    ...
    # Specific supermarket names first. Do not interpret loyalty terms like
    # "Lidl Plus" as the Plus supermarket.
    candidates = {
        "lidl": ["lidl arnhem", "lidl", "lidl plus"],
        "albert_heijn": ["albert heijn", "ah ", "bonus box"],
        "jumbo": ["jumbo"],
        "aldi": ["aldi", "alot"],
        "plus": ["plus supermarkt", "plus supermarkten", "pluspunten", "plussen digital"],
    }
