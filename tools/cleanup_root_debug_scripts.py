...
def main() -> None:
    ...
    if not candidates:
        print("OK: geen root_debug_scripts gevonden.")
        run_inventory()
        return

    print("Gevonden root_debug_scripts:")
    ...
    run_inventory()
    print("OK: root debug scripts verwijderd en Python-inventaris opnieuw gegenereerd.")
