...
- de camera-optie gebruikt waar het toestel dit ondersteunt de achtercamera via `capture="environment"`; op toestellen zonder camera-capture mag de browser terugvallen op de normale afbeeldingskiezer;
