...
class _Connection:
    def __init__(self, membership_role: str | None, platform_role_key: str | None):
...
class _Engine:
    def __init__(self, membership_role: str | None, platform_role_key: str | None):
        self.connection = _Connection(membership_role, platform_role_key)

    def begin(self):
        return _Begin(self.connection)


def _main_module(*, membership_role="member", platform_role_key=None):
    records = {
        LEGACY_DEFAULT_ADMIN_EMAIL: {
    ...
    return SimpleNamespace(
        ...
        engine=_Engine(membership_role, platform_role_key),
