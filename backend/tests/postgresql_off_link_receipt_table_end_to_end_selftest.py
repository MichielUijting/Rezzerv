...
def main() -> None:
    ...
    try:
        ...
        with engine.begin() as conn:
            ...
            if str(line.get("matched_global_product_id") or "") != global_product_id:
                raise AssertionError(line)
            if line.get("matched_article_id") not in (None, ""):
                raise AssertionError(line)
            if str(line.get("article_match_status") or "") != "product_matched":
                raise AssertionError(line)
        ...
        with engine.begin() as conn:
            ...
            if str(line_after_repeat.get("matched_global_product_id") or "") != global_product_id:
                raise AssertionError(line_after_repeat)
            if str(line_after_repeat.get("article_match_status") or "") != "product_matched":
                raise AssertionError(line_after_repeat)
        ...
        print("POSTGRESQL_OFF_LINK_RECEIPT_TABLE_LINE_GREEN")
