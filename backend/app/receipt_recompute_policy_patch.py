...
def _repair_missing_small_amount_line(conn, row: dict[str, Any], baseline: dict[str, Any] | None, line_count: int, line_total_sum: Any) -> dict[str, Any] | None:
    ...
    # Koopzegels/statiegeldachtige bedragregels zijn positieve, relatief kleine bedragen.
    # Grote gaten blijven bewust Controle nodig; die moeten door de echte parser worden opgelost.
