...
class ReceiptProfile(Protocol):
    ...
    def normalize_totals(self, *, total_amount: Decimal | None, discount_total: Decimal | None, lines: list[dict[str, Any]], context: ReceiptProfileContext) -> tuple[Decimal | None, Decimal | None]: ...
