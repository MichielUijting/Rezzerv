...
def inventory_groups(household_id: str | None = Query(default=None)):
    ...
    M2C2i-30A: this projection groups inventory across shops and brands.
    It is read-only for inventory: it does not create inventory events and does
    not change stock quantities.
    """
