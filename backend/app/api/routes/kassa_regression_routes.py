...
def _build_final_report(results: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "ran_at": _utc_now(),
        "acceptance_basis": "Baseline V8: 18 vaste testkassabonnen inclusief Picnic worden opnieuw door parse_receipt_content gehaald en in een tijdelijke aparte SQLite-testdatabase geschreven. Datum/tijd wordt nooit gevalideerd. Voor Picnic wordt totaalbedrag niet gevalideerd.",
