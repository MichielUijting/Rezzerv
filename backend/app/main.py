...
from app.api.receipt_ingestion_review_routes import (
    router as receipt_ingestion_review_router,
...
configure_receipt_ingestion_review_routes(
    allowed_test_runs_root=Path('tools') / 'receipt_csv_poc' / 'test_runs',
)
