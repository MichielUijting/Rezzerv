    ...
    async function load() {
      ...
      try {
        ...
        if (active) {
          showFeedback({
            variant: 'error',
            title: 'Huishouden niet geladen',
            message: error?.message || 'De huishoudgegevens konden niet worden geladen.',
          })
        }
      } finally {
  ...
  async function runMutation(task, successMessage) {
    ...
    try {
      ...
      showFeedback({
        ...
        message: error?.message || 'De wijziging kon niet worden opgeslagen.',
      })
      return false
    } finally {
      setIsSaving(false)
            ...
            <div className="rz-household-header">
              <div>
                ...
                <p className="rz-household-subtitle">
                  Beheer de naam van het huishouden en welke gebruikers eraan zijn gekoppeld.
                </p>
                <p className="rz-household-summary">{householdSummary}</p>
                {!isLoading && !isAdmin ? (
                  <p className="rz-household-warning">
                    Alleen een beheerder kan de huishoudnaam wijzigen of leden koppelen en ontkoppelen.
                  </p>
                ) : null}
              </div>
            </div>
              ...
              <>
                <section className="rz-household-name-section">
                  <div>
                    ...
                    <p className="rz-household-section-copy">
                      Deze naam wordt gebruikt in de actieve huishoudcontext en in uitnodigingen.
                    </p>
                  </div>
                ...
                <section className="rz-household-form-section">
                  <div>
                    ...
                    <p className="rz-household-section-copy">
                      Rollen en individuele rechten beheer je uitsluitend via Huishoudleden en autorisaties.
                    </p>
                  </div>
                      ...
                      >
                        <div className="rz-household-member-content">
                          ...
                          <div className="rz-household-member-meta">
                            {member.is_current_user ? 'Huidige gebruiker' : 'Gekoppeld huishoudlid'}
                          </div>
                        </div>
                ...
                <section className="rz-household-form-section">
                  <div>
                    ...
                    <p className="rz-household-section-copy">
                      Nieuwe leden krijgen standaard de rol Lid. Pas de rol daarna aan in Huishoudleden en autorisaties.
                    </p>
                  </div>
