...
export default function SettingsSpacesPage() {
  ...
  function exportCsv() {
    ...
    link.href = url
    link.download = 'inhuis-ruimtes.csv'
...
<input
                      ...
                      <td className="rz-num">
                        <input type="checkbox" style={{ accentColor: '#005F6A', width: 16, height: 16 }} checked={Boolean(item.active)} readOnly aria-label={`Actief ${item.naam}`} />
                      </td>
