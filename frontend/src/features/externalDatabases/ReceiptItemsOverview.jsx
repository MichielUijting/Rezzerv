...
export default function ReceiptItemsOverview({ onError, onMessage }) {
  ...
  useEffect(() => {
    ...
    const suggested = linkedProductTypeId || suggestProductTypeId(selectedCandidate, productTypeOptions)
  ...
  }, [selectedCandidateId, productTypeOptions, selectedItem?.id, selectedItem?.linkedProductTypeId, selectedItem?.catalogLinked])
