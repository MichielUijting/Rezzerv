...
function HouseholdInspector({ householdId }) {
  ...
  const allUsersSelected = realMemberKeys.length > 0 && realMemberKeys.every((key) => selectedUserKeys.includes(key)), includeUnattributed = selectedUserKeys.includes(UNATTRIBUTED_KEY), fullSelection = allUsersSelected && includeUnattributed
