...
const GENERIC_MESSAGE = 'Als dit e-mailadres bij ons bekend is, ontvang je een e-mail waarmee je je wachtwoord opnieuw kunt instellen.'
        ...
        <div className="rz-content-inner">
          <Card className="rz-card-login">
            <form className="rz-form" onSubmit={onSubmit}>
              <p style={{ marginTop: 0 }}>
                Vul het e-mailadres van je Inhuis-account in. Als het bij ons bekend is, sturen we een beveiligde herstellink.
              </p>
              <Input
                label="E-mail"
                type="email"
              ...
              <div style={{ textAlign: 'center' }}>
                <Link to="/login" data-testid="forgot-password-back-login">Terug naar inloggen</Link>
              </div>
              {message ? <div className="rz-inline-feedback rz-inline-feedback--success" data-testid="forgot-password-success">{message}</div> : null}
