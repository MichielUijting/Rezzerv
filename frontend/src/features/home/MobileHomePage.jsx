...
const ACTION_ICONS = {
  ...
  kassabonnen: <svg className="rz-illustrated-icon" viewBox="0 0 64 64" aria-hidden="true"><path fill="#f0b45e" d="M13 22h38l-4 36H17z"/><path d="M23 24v-5c0-12 18-12 18 0v5" fill="none" stroke="#9c5d16" strokeWidth="5" strokeLinecap="round"/><path d="M14 32h36M13 40h36M12 48h36" strokeWidth="4" strokeLinecap="round" stroke="#ef5350"/><path d="M19 32h9m7 0h9M17 40h8m8 0h10M16 48h10m7 0h9" strokeWidth="4" strokeLinecap="round" stroke="#42a5f5"/></svg>,
