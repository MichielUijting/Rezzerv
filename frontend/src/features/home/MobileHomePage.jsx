...
const ACTION_ICONS = {
  kassa: <svg className="rz-illustrated-icon" viewBox="0 0 64 64" aria-hidden="true"><path fill="#455a64" d="M10 31h44l5 25H5z"/><rect x="16" y="10" width="32" height="20" rx="5" fill="#90a4ae"/><rect x="21" y="14" width="22" height="9" rx="2" fill="#b2f2e9"/><path fill="#fff" d="M9 21h13v22H9z"/><path stroke="#cfd8dc" strokeWidth="2" d="M12 26h7m-7 5h7m-7 5h7"/><rect x="26" y="34" width="24" height="14" rx="3" fill="#cfd8dc"/><g fill="#ff9f43"><circle cx="31" cy="39" r="2.5"/><circle cx="38" cy="39" r="2.5"/><circle cx="45" cy="39" r="2.5"/><circle cx="31" cy="45" r="2.5"/><circle cx="38" cy="45" r="2.5"/><circle cx="45" cy="45" r="2.5"/></g><rect x="14" y="50" width="36" height="4" rx="2" fill="#263238"/></svg>,
  kassabonnen: <svg className="rz-illustrated-icon" viewBox="0 0 64 64" aria-hidden="true"><path fill="#d99032" d="M12 22h40l-4 36H16z"/><path fill="#f0b45e" d="M17 20h30l4 35-19 5-19-5z"/><path d="M23 24v-5c0-12 18-12 18 0v5" fill="none" stroke="#9c5d16" strokeWidth="5" strokeLinecap="round"/><path fill="#7cb342" d="M20 19c4-8 9-8 13 0z"/><circle cx="39" cy="18" r="7" fill="#ef5350"/><path fill="#f6c34a" d="M34 8l5 12 5-12z"/></svg>,
  ...
  meldingen: <svg className="rz-illustrated-icon" viewBox="0 0 64 64" aria-hidden="true"><path fill="#fff" stroke="#ef5350" strokeWidth="3" d="M8 34l30-13v27L8 38z"/><path fill="#1976d2" d="M38 18h10v33H38z"/><path fill="#ef5350" d="M15 38l9 18h10l-8-21z"/><rect x="28" y="5" width="34" height="18" rx="7" fill="#f44336"/><text x="45" y="18" textAnchor="middle" fontSize="9" fontWeight="800" fill="#fff">NIEUWS</text><path d="M5 24L1 20m8-3V10" stroke="#ffb300" strokeWidth="4" strokeLinecap="round"/></svg>,
}
const META = {
