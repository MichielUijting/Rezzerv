...
export const articleFieldConfig = [
  ...
  { key: 'barcode', tab: ARTICLE_TABS.OVERVIEW, group: FIELD_GROUPS.EXTERNAL, label: 'Barcode', visibilityType: 'default_on', applicableArticleTypes: [ARTICLE_TYPES.ALL], editable: true, order: 110 },
