...
export default function StoresPage() {
  ...
  useDismissOnComponentClick([() => setError(''), () => setStatus('')], Boolean(error || status))
  ...
  const isHouseholdAdmin = Boolean(household?.is_household_admin)
  ...
  return (
    <AppShell title="Import kassabon" showExit={false}>
      <div style={{ display: 'grid', gap: '16px' }}>
        <Card>
          <div data-testid="stores-page-intro" style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'grid', gap: '8px' }}>
              <h2 style={{ margin: 0, fontSize: '20px' }}>Import kassabon</h2>
        ...
        {!isLoading && !isHouseholdAdmin ? (
          <Card>
            <div className="rz-inline-feedback rz-inline-feedback--warning" data-testid="stores-member-warning">
              Alleen de beheerder van het huishouden kan winkels koppelen of nieuwe aankopen ophalen. Je kunt bestaande bonnen wel bekijken.
            </div>
          </Card>
        ) : null}
        ...
        {!isLoading && isViewer ? (
          <Card>
            <div className="rz-inline-feedback rz-inline-feedback--warning" data-testid="stores-viewer-warning">
              Kijkers mogen kassabonnen wel opvoeren en bekijken, maar niet naar voorraad verwerken.
            </div>
          </Card>
        ) : null}
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px', flexWrap: 'wrap' }}>
                      ...
                      <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
                        ...
                        <Button
                          ...
                          disabled={busyBatchId === batch.batch_id || isProcessingBatch || (isViewer && batch.uiState.actionType === 'process')}
                        >
                  ...
                  return (
                    <div key={item.code} data-testid={`store-provider-${item.code}`} style={connectedStoreRowStyle}>
                      ...
                      <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                        ...
                        {!connection && provider && isHouseholdAdmin ? (
