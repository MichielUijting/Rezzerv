...
const f604ExplicitInterruptedMutationAuthority = process.argv.some((argument) => argument.includes('f6-04-interrupted-mutation-safe-resume.fullstack.spec.js'))
...
const fullstackTestMatch = f604ExplicitInterruptedMutationAuthority
  ? /f6-04-interrupted-mutation-safe-resume\.fullstack\.spec\.js/
  : f603ExplicitInvalidImportAuthority
