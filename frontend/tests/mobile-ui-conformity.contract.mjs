...
assert.match(mobileArticleSource, /<MobileModuleHeader title="Voorraad" testId="mobile-article-header" \/>/)
assert.match(mobileArticleSource, /data-testid="mobile-article-back-to-inventory"/)
