...
assert.match(catalogSource, /const isPlatformSuperuser = Boolean\(authContext\?\.is_platform_superuser\)/)
assert.doesNotMatch(catalogSource, /isPlatformSuperuserFromContext/)
