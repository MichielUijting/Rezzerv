...
includes(shopping, "import SearchCandidateList from '../../ui/SearchCandidateList.jsx'", 'Boodschappen gebruikt niet de centrale zoekkandidatenlijst')
includes(shopping, 'Boodschappen', 'Gebruikerszichtbare Boodschappen-titel ontbreekt')
