...
includes(shopping, "import SearchCandidateList from '../../ui/SearchCandidateList.jsx'", 'Boodschappenlijst gebruikt niet de centrale zoekkandidatenlijst')
includes(shopping, 'Boodschappenlijst', 'Gebruikerszichtbare Boodschappenlijst-titel ontbreekt')
excludes(shopping, 'Zoekresultaat', 'Gesloten tussenstap Zoekresultaat mag niet meer bestaan')
