...
assert.match(headerCss, /\.rz-header\s*\{[\s\S]*?background:\s*var\(--color-brand-primary\)/)
assert.match(headerCss, /@media \(max-width: 720px\)[\s\S]*?\.rz-header\s*\{[\s\S]*?background:\s*var\(--color-brand-primary\)/)
