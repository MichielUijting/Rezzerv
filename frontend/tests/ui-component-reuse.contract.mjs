...
const mobileAppChrome = readFileSync(path.join(frontendRoot, 'src/app/MobileAppChrome.jsx'), 'utf8')
...
assert.doesNotMatch(mobileInventory, /<MobileRecentActionsBar/)
assert.match(mobileAppChrome, /<MobileRecentActionsBar/)
