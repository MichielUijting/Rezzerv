...
assert.match(mobileSource, /data-testid="mobile-article-stock-minus"/)
assert.match(mobileSource, /data-testid="mobile-article-stock-plus"/)
...
assert.match(styleguide, /## Mobiele navigatie/)
assert.match(styleguide, /browsergeschiedenis blijft leidend/)
assert.match(styleguide, /iOS.*Android/s)
assert.match(styleguide, /## Mobiel Voorraad-artikeldetail/)
assert.match(styleguide, /Voorkeurswinkel/)
assert.match(styleguide, /Aankoophistorie/)
assert.match(styleguide, /Naar inkooplijstje/)
assert.match(styleguide, /Winkelen/)
assert.match(styleguide, /Waar Inhuis/)
assert.match(styleguide, /geen vaste algemene `Opslaan`-knop/)
