...
assert.match(mobileCss, /\.rz-mobile-article-functional-tabs > \.rz-tabbar \.rz-tab\s*\{[\s\S]*border-radius:\s*999px/)
assert.match(mobileCss, /\.rz-mobile-article-functional-tabs > \.rz-tabbar \.rz-tab\.rz-tab-active\s*\{[\s\S]*background:\s*#edf5f3/)
